...
func (x *IsAdminResponce) GetIdAdmin() bool {
	if x != nil {
		return x.IdAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bid_admin\x18\x01 \x01(\bR\aidAdmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponceB\x14Z\x12drplx.sso.v1;ssov1b\x06proto3"
